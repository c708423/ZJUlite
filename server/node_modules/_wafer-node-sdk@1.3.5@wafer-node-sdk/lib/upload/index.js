...
module.exports = (req) => {
    // 初始化 sdk
    console.log(`http://${config.cos.fileBucket}-${config.qcloudAppId}.cos.${config.cos.region}.myqcloud.com/`);
            ...
            return new Promise((resolve, reject) => {
                ...
                cos.putObject(params, (err, data) => {
                    ...
                    // remove uploaded file
                      ...
                      debug('error happened at wafer-node-sdk > lib > upload > index.js when remove uploaded file after uploaded succcessfully')
                    }
                })
            })
        })
